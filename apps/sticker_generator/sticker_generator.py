...
# model_path_sdxl = ("../models/models--stabilityai--stable-diffusion-xl-base-1.0/" "snapshots/462165984030d82259a11f4367a4eed129e94a7b")

model_path_sdxl = (f"C:/Users/damil/PycharmProjects/ai_course/models/models--stabilityai--stable-diffusion-xl-base-1.0/""snapshots/462165984030d82259a11f4367a4eed129e94a7b")

# lora_path = ("../models/Loras/SDXL-StickerSheet-Lora.safetensors")
lora_path = "Norod78/SDXL-StickerSheet-Lora"

base, refiner = load_model_local_sdxl(model_path_sdxl, None, lora_path)

user_input = st.text_input("Enter your prompt", value="lion")
lora_trigger = "StickerSheet"
